      ...
      <div className="p-6 sm:p-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mb-8 sm:mb-10">
          {[
            ...
            return (
              <div key={stat.label} className="bg-white border border-gray-100 rounded-2xl p-5 sm:p-6 shadow-sm">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <Link
              ...
              className="flex items-center gap-4 bg-white border border-gray-100 rounded-2xl p-5 hover:border-indigo-200 hover:shadow-sm transition-all group"
            >
              ...
              <div className="min-w-0">
                <p className="font-semibold text-gray-900">Create a new job</p>
                <p className="text-sm text-gray-500 truncate">Set up AI screening questions</p>
              </div>
              <ArrowRight size={17} className="ml-auto text-gray-300 group-hover:text-indigo-500 flex-shrink-0 transition-colors" />
            </Link>
            <Link
              href="/dashboard/jobs"
              className="flex items-center gap-4 bg-white border border-gray-100 rounded-2xl p-5 hover:border-purple-200 hover:shadow-sm transition-all group"
            >
              ...
              <div className="min-w-0">
                <p className="font-semibold text-gray-900">View candidates</p>
                <p className="text-sm text-gray-500 truncate">Browse your pipeline and scores</p>
              </div>
